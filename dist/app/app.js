(function(){
  ...
  var requires = ["ionic","twx.byoc","ngBarcodeScannerService"];
...
'  </div>\n'+
'</twx-container-content>\n'+
'</div></twx-widget-content></twx-widget></ion-view>\n';
...
// function   example  ...$scope.myfunction =function() {
...
var experienceInfo = new twx.app.ExperienceInfo({"name":"","version":"1.0.0","requires":["w320dp"],"experiences":[{"vumark":"29407:1","experienceType":"vumark","id":1,"index-keys":["urn:vuforia:vumark:29407:1"],"title":{"en":"3D Label"},"description":{"en":"","en-US":""},"requires":["AR-tracking"],"tags":[],"icon":"","viewName":"Home","url-template":"index.html?expId=1&vumark={{vuforia:vumark}}","entryPoint":"index.html?expId=1","thumbnail":""}],"accessType":"private","designedfor":[]});
